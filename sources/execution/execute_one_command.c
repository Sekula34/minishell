...
//originalstdin and originalstdout
// containt stdin and stdout fd
//they are used to reset stdin and stoud to 0 an 1 
//after redirection redirect stdin and stoud 
//to some custom files
//this original stdin and stoud are open from seting 
//until end of this function
//therfore in execution if execution is making 
//childre they are inherited and they need to be close in child
